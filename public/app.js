 ...
 * DNA: Cerebro v12.0 Master Live (Versión Final Sincronizada y Blindada)
 */
...
// --- 5. MAPA DE MESAS Y CUENTAS SEPARADAS ---
...
async function guardarPedidoTemporal() {
    ...
    reproducirSonido('exito'); if(socket) socket.emit('notificar_cambio'); 
...
async function procesarPegadoMasivo() {
    ...
    if(socket) socket.emit('notificar_cambio'); cerrarModal();
}
